...
modifided_table = newtab.split_directions(str(tables[0]))
...
workdays = newtab.get_workdays(timecodes, newtab.get_subgroup(keys[3]), sorted_lines)
for workday in workdays:
    print(workday)